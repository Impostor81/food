window.addEventListener('DOMContentLoaded', function() {
    ...
    // если использовать сервер MAMP и json-server тогда будет путь другой6
    ...
    // простой слайдер переключения картинок 
    ...
    // более сложный слайдер, карусель с точками навигации
    let offset = 0;
    let slideIndex = 1;
